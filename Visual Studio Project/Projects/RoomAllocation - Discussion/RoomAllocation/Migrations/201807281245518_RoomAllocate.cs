namespace RoomAllocation.Migrations
{
    ...
    public partial class RoomAllocate : DbMigration
    {
        ...
        {
            DropForeignKey("dbo.AllocateRooms", "userID", "dbo.User");
            DropForeignKey("dbo.AllocateRooms", "roomID", "dbo.Room");
            DropIndex("dbo.AllocateRooms", new[] { "userID" });
